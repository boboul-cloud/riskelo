...
Depuis la 1.5, « La conquête sans dés » n'est plus vraie : on peut jouer aux
dés. Autre variante : `Conquérir, en répondant juste` (29)
...
97 caractères. Le nom et le sous-titre sont déjà indexés : ne pas y répéter
« Riskelo », « conquête » ni « culture générale ». **Aucune marque de jeu de société** — c'est un
...
La donnée, c'est le numéro tiré au sort à l'installation que le relais du jeu
au loin garde **une semaine** après la dernière séance, pour qu'une partie se
reprenne un autre soir. Apple compte comme collecté ce qui est gardé hors de
l'appareil plus longtemps que la requête immédiate : une semaine, c'est plus
long. Le détail est dans `confidentialite-app-store.md`.
...
l'installation, qu'il garde une semaine après la dernière séance pour qu'une
partie se reprenne un autre soir, puis efface. Aucun journal n'est conservé.
